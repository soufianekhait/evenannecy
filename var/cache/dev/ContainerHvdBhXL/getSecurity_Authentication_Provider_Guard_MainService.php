...
return $this->privates['security.authentication.provider.guard.main'] = new \Symfony\Component\Security\Guard\Provider\GuardAuthenticationProvider(new RewindableGenerator(function () {
    ...
    yield 1 => ($this->privates['App\Security\AppCustomAuthenticator'] ?? $this->load('getAppCustomAuthenticatorService.php'));
}, 2), ($this->privates['security.user.provider.concrete.app_user_provider'] ?? $this->load('getSecurity_User_Provider_Concrete_AppUserProviderService.php')), 'main', new \Symfony\Component\Security\Core\User\UserChecker());
