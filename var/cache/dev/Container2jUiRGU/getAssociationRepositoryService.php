...
// Returns the private 'App\Repository\AssociationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AssociationRepository.php';

return $this->privates['App\Repository\AssociationRepository'] = new \App\Repository\AssociationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
