...
include_once $this->targetDirs[3].'\\src\\Security\\AppAuthenticationAuthenticator.php';
...
}, 5), new \Symfony\Component\Security\Http\Firewall\ExceptionListener(($this->services['security.token_storage'] ?? ($this->services['security.token_storage'] = new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage())), ($this->privates['security.authentication.trust_resolver'] ?? ($this->privates['security.authentication.trust_resolver'] = new \Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver(NULL, NULL))), new \Symfony\Component\Security\Http\HttpUtils($a, $a, '{^https?://%s$}i', '{^https://%s$}i'), 'main', ($this->privates['App\Security\AppAuthenticationAuthenticator'] ?? ($this->privates['App\Security\AppAuthenticationAuthenticator'] = new \App\Security\AppAuthenticationAuthenticator())), NULL, NULL, ($this->privates['monolog.logger.security'] ?? $this->load('getMonolog_Logger_SecurityService.php')), false), NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('main', 'security.user_checker', NULL, true, false, 'security.user.provider.concrete.in_memory', 'main', 'App\\Security\\AppAuthenticationAuthenticator', NULL, NULL, [0 => 'guard', 1 => 'anonymous'], NULL));
