...
// Returns the private 'App\Repository\ParticularRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ParticularRepository.php';

return $this->privates['App\Repository\ParticularRepository'] = new \App\Repository\ParticularRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
