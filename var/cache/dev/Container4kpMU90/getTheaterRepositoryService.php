...
// Returns the private 'App\Repository\TheaterRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TheaterRepository.php';

return $this->privates['App\Repository\TheaterRepository'] = new \App\Repository\TheaterRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
